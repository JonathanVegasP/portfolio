...
import 'package:portfolio/widgets/molecules/hello_world_container.dart';
import 'package:portfolio/widgets/molecules/hello_world_project.dart';
import 'package:portfolio/widgets/molecules/project_container.dart';
...
class ProjectsWidget extends StatelessWidget with UrlLauncherMixin {
  ...
  Widget build(BuildContext context) {
    return ProjectsContainer(
      ...
      children: [
        ProjectContainer(
          projectChild: const PhoneWidget(child: HelloWorldProject()),
          detailsChildren: [
